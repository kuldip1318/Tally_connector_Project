...
async function createOrUpdateCompanyDetailsTable(client) {
...
async function createOrUpdateSubscriberDbTable(client) {
...
async function createOrUpdateOtherTables(client) {
...
async function createTables() {
  ...
  try {
    ...
    await createOrUpdateCompanyDetailsTable(client);

    // Check and create subscriber_db table
    await createOrUpdateSubscriberDbTable(client);

    // Check and create other tables (tally_data, tally_groups, tally_ledgers, ledger_monthly_summary)
    await createOrUpdateOtherTables(client);
